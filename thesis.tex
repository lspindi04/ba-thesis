...
\newcommand{\titel}{Entwicklung und Konzeption eines Device-Integration-Plugins für zenLAB}
\newcommand{\artderarbeit}{Bachelorarbeit}
\newcommand{\autor}{Lukas Spindler}
\newcommand{\studiengang}{Informatik}
\newcommand{\matrikelnr}{3728783}
\newcommand{\erstgutachter}{Prof.\,Dr.~Matthias Teßmann}
\newcommand{\zweitgutachter}{Prof.\,Dr.~Matthias Meitner}
\newcommand{\betreuer}{Jonas Krammer}
\newcommand{\unternehmen}{infoteam Software AG}
...
\usepackage{xurl} % Erlaubt Umbrüche auch innerhalb langer Literatur-URLs.
...
\include{content/0_abstract}\clearpage
...
\include{content/3_anforderungsanalyse}
\include{content/4_konzeption_und_implementierung}
